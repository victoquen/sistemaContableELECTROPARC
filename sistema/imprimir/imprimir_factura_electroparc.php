...
<script>
    ...
    doc.text(xx, yyy, '10000');//sub total
    yyy+=5.8;
    doc.text(xx, yyy, '10000');//descuento
    yyy+=5.8;
    doc.text(xx, yyy, '10000');//iva tari 0%
    yyy+=5.8;
    doc.text(xx, yyy, '10000');//iva tarifa % configurable
    yyy+=5.8;
    doc.text(xx, yyy, '10000');//importe del iva
    yyy+=5.8;
    doc.text(xx, yyy, '10000');//valor total
    yyy+=5.8;
    doc.save('Test.pdf');
