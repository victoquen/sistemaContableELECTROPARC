						...
						<tr>
							...
							<td><?php echo $idcliente?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="43%"><input NAME="Anombres" type="text" class="cajaGrande" id="nombre" value="<?php echo $row['nombre']?>" size="44" ></td>

                                                </tr>

                                                <tr>
                                                    <td width="15%">Empresa</td>
                                                    <td width="43%"><input NAME="aempresa" type="text" class="cajaGrande" id="empresa" value="<?php echo $row['empresa']?>" size="50" ></td>
                                                </tr>
