...
if ($accion == "insertar") {
    ...
    $retiva = $_POST["ret_iva"];
    $retfuente = $_POST["Rret_fuente"];
    $totalfactura = $_POST["idtotalfactura"];
...
<head>
    ...
    <script language="javascript">
        ...
        function ver_cobros(idfactura) {
            parent.location.href = "ver_cobros.php?idfactura=" + idfactura + "&cadena_busqueda=<?php  echo $cadena_busqueda?>";
        }
    ...
    <div align="center">
            ...
            <form name="form1" id="form1">
                ...
                while ($contador < mysql_num_rows($res_resultado)) {
                    ...
                    <tr class="<?php  echo $fondolinea ?>">
                        ...
                        <td width="13%">
                            <div
                                align="center"><?php  echo implota(mysql_result($res_resultado, $contador, "fechacobro")) ?></div>
                        </td>
                        <td width="13%">
                            <div
                                align="center"><?php  echo number_format(mysql_result($res_resultado, $contador, "importe"), 2, ",", ".") ?></div>
                        </td>
                        <td width="20%">
                            <div align="center"><?php  echo mysql_result($res_resultado, $contador, "nombrefp") ?></div>
                        </td>
                        ...
                        <td width="5%">
                            <div align="center"><a href="#"><img src="../img/observaciones.png" width="16" height="16"
                                                                 border="0"
                                                                 onClick="abreVentana('<?php  echo mysql_result($res_resultado, $contador, "observaciones") ?>')"
                                                                 title="Ver Observaciones"></a></div>
                        </td>
                        <td width="5%">
                            <div align="center"><a href="#"><img src="../img/eliminar.png" width="16" height="16"
                                                                 border="0"
                                                                 onClick="eliminar('<?php  echo mysql_result($res_resultado, $contador, "id_factura") ?>','<?php  echo mysql_result($res_resultado, $contador, "id_cobro") ?>','<?php  echo mysql_result($res_resultado, $contador, "fechacobro") ?>','<?php  echo mysql_result($res_resultado, $contador, "importe") ?>')"
        ...
        <?php  } else { ?>
            <table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
                <tr>
                    <td width="100%"
                        class="mensaje"><?php  echo "Todav&iacute;a no se ha producido ning&uacute;n cobro de esta factura."; ?></td>
                </tr>
            </table>
        <?php  } ?>
        </form>
