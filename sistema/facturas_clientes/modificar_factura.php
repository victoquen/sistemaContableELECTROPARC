                    ...
                    <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                        ...
                        <tr>
                            ...
                            <td><input NAME="fecha" type="text" class="cajaPequena" id="fecha" size="10" maxlength="10"
                                       value="<?php echo implota($fecha) ?>" readonly> <img src="../img/calendario.png"
            ...
            <div id="frmBusqueda">
                ...
                <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=1>
                    ...
                    <tr class="itemImparTabla">
                        <td><input NAME="codarticulo1" id="codarticulo1" type="text" class="cajaPequena" size="15"
                                   maxlength="15" value="<?php echo $codarticulo1; ?>" readonly></td>
                        <td>
                            ...
                            <input NAME="descripcion1" id="descripcion1" type="text" class="cajaExtraGrande"
                                   onClick="ventanaArticulos(1)" value="<?php echo $descripcion1; ?>" readonly>
                            <?php if ($iva1 != 0) { ?>
                                <input style="display: inherit" name="grabaiva1" id="grabaiva1" class="cajaExtraMinima"
                                       readonly>
                            <?php } else { ?>
                        ...
                        <?php if ($idfactulinea1) { ?>
                            <td align="center"><input NAME="cantidad1" id="cantidad1" type="text" class="cajaMinima"
                                                      size="10" maxlength="10" value="<?php echo $cantidad1; ?>"
                                                      onChange="actualizar_importe(1)"></td>
                        <?php } else { ?>
                            <td align="center"><input NAME="cantidad1" id="cantidad1" type="text" class="cajaMinima"
                                                      size="10" maxlength="10" value="1"
                                                      onChange="actualizar_importe(1)"></td>
                        <?php } ?>
                        <td align="center"><input NAME="precio1" id="precio1" type="text" class="cajaPequena2" size="10"
                                                  maxlength="10" value="<?php echo $precio1; ?>"
                                                  onChange="actualizar_importe(1)"></td>

                        <td align="center">
                            <?php if ($idfactulinea1) { ?>
                                <input NAME="descuentoporc1" id="descuentoporc1" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(1)"
                                       value="<?php echo $descuento_porcentaje1; ?>">%
                                <input NAME="descuento1" id="descuento1" type="text" class="cajaPequena2" size="10"
                                       maxlength="10" value="<?php echo $descuento_ind1 ?>"
                                       onchange="actualizar_porcentaje_descuento(1)">&#36;
                            <?php } else { ?>
                                <input NAME="descuentoporc1" id="descuentoporc1" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(1)" value="0">%
                                <input NAME="descuento1" id="descuento1" type="text" class="cajaPequena2" size="10"
                                       maxlength="10" value="0" onchange="actualizar_porcentaje_descuento(1)">&#36;
                            <?php } ?>
                        </td>
                        <?php if ($idfactulinea1) { ?>
                            <td align="center"><input NAME="subt1" id="subt1" type="text" class="cajaPequena2"
                                                      value="<?php echo $subtotal1 - $descuento_ind1 + $iva1 ?>"
                                                      readonly></td>
                        <?php } else { ?>
                        ...
                        <td align="center"><img src="../img/eliminar.png" width="16" height="16"
                                                onClick="limpiar_articulo(1)" onMouseOver="style.cursor = cursor"
                                                title="Eliminar"></td>
                    </tr>


                    <?php if ($idfactulinea1) { ?>
                        <input name="idfactulinea1" id="idfactulinea1" type="hidden"
                               value="<?php echo $idfactulinea1; ?>">
                        ...
                        <input name="transformacion1" id="transformacion1" value="<?php echo $transformacion1; ?>"
                               type="hidden">
                        <input name="precio_con_iva1" id="precio_con_iva1" value="<?php echo $precio_con_iva1; ?>"
                               type="hidden">
                    ...
                    <?php if ($iva1 != 0) { ?>
                        <input NAME="ivaporc1" id="ivaporc1" type="hidden" value="<?php echo $ivaporcetaje; ?>"
                               onChange="suma_iva(1)">
                    <?php } else { ?>
                    ...
                    if ($idfactulinea2) {
                        ...
                        <tr class="itemParTabla">
                            <td><input NAME="codarticulo2" id="codarticulo2" type="text" class="cajaPequena" size="15"
                                       maxlength="15" value="<?php echo $codarticulo2; ?>" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(2)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion2" id="descripcion2" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" value="<?php echo $descripcion2 ?>"
                                       onClick="ventanaArticulos(2)" readonly>
                                <?php if ($iva2 != 0) { ?>
                                    <input style="display: inherit" name="grabaiva2" id="grabaiva2"
                                           class="cajaExtraMinima" readonly>
                                <?php } else { ?>
                            ...
                            <td align="center"><input NAME="cantidad2" id="cantidad2" type="text" class="cajaMinima"
                                                      size="10" maxlength="10" value="<?php echo $cantidad2 ?>"
                                                      onChange="actualizar_importe(2)"></td>
                            <td align="center"><input NAME="precio2" id="precio2" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" value="<?php echo $precio2 ?>"
                                                      onChange="actualizar_importe(2)"></td>

                            <td align="center">
                                <input NAME="descuentoporc2" id="descuentoporc2" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(2)"
                                       value="<?php echo $descuento_porcentaje2; ?>">%
                                <input NAME="descuento2" id="descuento2" type="text" class="cajaPequena2" size="10"
                                       maxlength="10" value="<?php echo $descuento_ind2 ?>"
                                       onchange="actualizar_porcentaje_descuento(2)">&#36;
                            </td>

                            <td align="center"><input NAME="subt2" id="subt2" type="text" class="cajaPequena2"
                                                      onchange="actualizar_totales(2)"
                                                      value="<?php echo $subtotal2 - $descuento_ind2 + $iva2 ?>"
                                                      readonly></td>
                            <td align="center"><img src="../img/eliminar.png" width="16" height="16"
                        ...
                        <input name="idfactulinea2" id="idfactulinea2" type="hidden"
                               value="<?php echo $idfactulinea2; ?>">
                        ...
                        <input name="transformacion2" id="transformacion2" type="hidden"
                               value="<?php echo $transformacion2; ?>">
                        <input name="precio_con_iva2" id="precio_con_iva2" type="hidden"
                               value="<?php echo $precio_con_iva2; ?>">
                        ...
                        <?php if ($iva2 != 0) { ?>
                            <input NAME="ivaporc2" id="ivaporc2" type="hidden" value="<?php echo $ivaporcetaje; ?>"
                                   onChange="suma_iva(2)">
                        <?php } else { ?>
                        ...
                        <tr class="itemParTabla">
                            ...
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(2)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion2" id="descripcion2" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" onClick="ventanaArticulos(2)" readonly>
                                <input style="display: none" name="grabaiva2" id="grabaiva2" class="cajaExtraMinima"
                                       readonly>
                            </td>
                            <td align="center">
                            ...
                            <td align="center"><input NAME="cantidad2" id="cantidad2" type="text" class="cajaMinima"
                                                      ...
                                                      onChange="actualizar_importe(2)"></td>
                            <td align="center"><input NAME="precio2" id="precio2" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" onChange="actualizar_importe(2)"></td>

                            <td align="center">
                                <input NAME="descuentoporc2" id="descuentoporc2" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(2)" value="0">%
                                <input NAME="descuento2" id="descuento2" type="text" class="cajaPequena2" size="10"
                    ...
                    if ($idfactulinea3) {
                        ...
                        ?>
                        <tr class="itemImparTabla">
                            <td><input NAME="codarticulo3" id="codarticulo3" type="text" class="cajaPequena" size="15"
                                       maxlength="15" value="<?php echo $codarticulo3 ?>" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(3)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion3" id="descripcion3" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" value="<?php echo $descripcion3 ?>"
                                       onClick="ventanaArticulos(3)" readonly>
                                <?php if ($iva3 != 0) { ?>
                                    <input style="display: inherit" name="grabaiva3" id="grabaiva3"
                                           class="cajaExtraMinima" readonly>
                                <?php } else { ?>
                            ...
                            <td align="center"><input NAME="cantidad3" id="cantidad3" type="text" class="cajaMinima"
                                                      size="10" maxlength="10" value="<?php echo $cantidad3 ?>"
                                                      onChange="actualizar_importe(3)"></td>
                            <td align="center"><input NAME="precio3" id="precio3" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" value="<?php echo $precio3 ?>"
                                                      onChange="actualizar_importe(3)"></td>

                            <td align="center">
                                <input NAME="descuentoporc3" id="descuentoporc3" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(3)"
                                       value="<?php echo $descuento_porcentaje3; ?>">%
                                <input NAME="descuento3" id="descuento3" type="text" class="cajaPequena2" size="10"
                                       maxlength="10" value="<?php echo $descuento_ind3; ?>"
                                       onchange="actualizar_porcentaje_descuento(3)">&#36;
                            </td>
                            <td align="center"><input NAME="subt3" id="subt3" type="text" class="cajaPequena2"
                                                      value="<?php echo $subtotal3 - $descuento_ind3 + $iva3 ?>"
                        ...
                        <input name="idfactulinea3" id="idfactulinea3" type="hidden"
                               value="<?php echo $idfactulinea3; ?>">
                        ...
                        <input name="transformacion3" id="transformacion3" value="<?php echo $transformacion3; ?>"
                               type="hidden">
                        <input name="precio_con_iva3" id="precio_con_iva3" value="<?php echo $precio_con_iva3 ?>"
                               type="hidden">
                        ...
                        <?php if ($iva3 != 0) { ?>
                            <input NAME="ivaporc3" id="ivaporc3" value="<?php echo $ivaporcetaje; ?>" type="hidden"
                                   onChange="suma_iva(3)">
                        <?php } else { ?>
                        ...
                        <tr class="itemImparTabla">
                            ...
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(3)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion3" id="descripcion3" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" onClick="ventanaArticulos(3)" readonly>
                                <input style="display: none" name="grabaiva3" id="grabaiva3" class="cajaExtraMinima"
                                       readonly>
                            </td>
                            <td align="center">
                            ...
                            <td align="center"><input NAME="cantidad3" id="cantidad3" type="text" class="cajaMinima"
                                                      ...
                                                      onChange="actualizar_importe(3)"></td>
                            <td align="center"><input NAME="precio3" id="precio3" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" onChange="actualizar_importe(3)"></td>

                            <td align="center">
                                <input NAME="descuentoporc3" id="descuentoporc3" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(3)" value="0">%
                                <input NAME="descuento3" id="descuento3" type="text" class="cajaPequena2" size="10"
                    ...
                    if ($idfactulinea4) {
                        ...
                        ?>
                        <tr class="itemParTabla">
                            <td><input NAME="codarticulo4" id="codarticulo4" type="text" class="cajaPequena" size="15"
                                       maxlength="15" value="<?php echo $codarticulo4; ?>" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(4)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion4" id="descripcion4" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" value="<?php echo $descripcion4; ?>"
                                       onClick="ventanaArticulos(4)" readonly>
                                <?php if ($iva4 != 0) { ?>
                                    <input style="display: inherit" name="grabaiva4" id="grabaiva4"
                                           class="cajaExtraMinima" readonly>
                                <?php } else { ?>
                            ...
                            <td align="center"><input NAME="cantidad4" id="cantidad4" type="text" class="cajaMinima"
                                                      size="10" maxlength="10" value="<?php echo $cantidad4; ?>"
                                                      onChange="actualizar_importe(4)"></td>
                            <td align="center"><input NAME="precio4" id="precio4" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" value="<?php echo $precio4; ?>"
                                                      onChange="actualizar_importe(4)"></td>

                            <td align="center">
                                <input NAME="descuentoporc4" id="descuentoporc4" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(4)"
                                       value="<?php echo $descuento_porcentaje4; ?>">%
                                <input NAME="descuento4" id="descuento4" type="text" class="cajaPequena2" size="10"
                                       maxlength="10" value="<?php echo $descuento_ind4; ?>"
                                       onchange="actualizar_porcentaje_descuento(4)">&#36;
                            </td>

                            <td align="center"><input NAME="subt4" id="subt4" type="text" class="cajaPequena2"
                                                      value="<?php echo $subtotal4 - $descuento_ind4 + $iva4; ?>"
                        ...
                        <input name="idfactulinea4" id="idfactulinea4" type="hidden"
                               value="<?php echo $idfactulinea4; ?>">
                        ...
                        <input name="transformacion4" id="transformacion4" type="hidden"
                               value="<?php echo $transformacion4; ?>">
                        <input name="precio_con_iva4" id="precio_con_iva4" type="hidden"
                               value="<?php echo $precio_con_iva4; ?>">
                        ...
                        <?php if ($iva4 != 0) { ?>
                            <input NAME="ivaporc4" id="ivaporc4" <?php echo $ivaporcetaje; ?> type="hidden"
                                   onChange="suma_iva(4)">
                        <?php } else { ?>
                        ...
                        <tr class="itemParTabla">
                            ...
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(4)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion4" id="descripcion4" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" onClick="ventanaArticulos(4)" readonly>
                                <input style="display: none" name="grabaiva4" id="grabaiva4" class="cajaExtraMinima"
                                       readonly>
                            </td>
                            <td align="center">
                            ...
                            <td align="center"><input NAME="cantidad4" id="cantidad4" type="text" class="cajaMinima"
                                                      ...
                                                      onChange="actualizar_importe(4)"></td>
                            <td align="center"><input NAME="precio4" id="precio4" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" onChange="actualizar_importe(4)"></td>

                            <td align="center">
                                <input NAME="descuentoporc4" id="descuentoporc4" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(4)" value="0">%
                                <input NAME="descuento4" id="descuento4" type="text" class="cajaPequena2" size="10"
                    ...
                    if ($idfactulinea5) {
                        ...
                        ?>
                        <tr class="itemImparTabla">
                            <td><input NAME="codarticulo5" id="codarticulo5" type="text" class="cajaPequena" size="15"
                                       maxlength="15" value="<?php echo $codarticulo5; ?>" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(5)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion5" id="descripcion5" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" value="<?php echo $descripcion5; ?>"
                                       onClick="ventanaArticulos(5)" readonly>
                                <?php if ($iva5 != 0) { ?>
                                    <input style="display: inherit" name="grabaiva5" id="grabaiva5"
                                           class="cajaExtraMinima" readonly>
                                <?php } else { ?>
                            ...
                            <td align="center"><input NAME="cantidad5" id="cantidad5" type="text" class="cajaMinima"
                                                      size="10" maxlength="10" value="<?php echo $cantidad5; ?>"
                                                      onChange="actualizar_importe(5)"></td>
                            <td align="center"><input NAME="precio5" id="precio5" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" value="<?php echo $precio5; ?>"
                                                      onChange="actualizar_importe(5)"></td>

                            <td align="center">
                                <input NAME="descuentoporc5" id="descuentoporc5" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(5)"
                                       value="<?php echo $descuento_porcentaje5; ?>">%
                                <input NAME="descuento5" id="descuento5" type="text" class="cajaPequena2" size="10"
                                       maxlength="10" value="<?php echo $descuento_ind5; ?>"
                                       onchange="actualizar_porcentaje_descuento(5)">&#36;
                            </td>

                            <td align="center"><input NAME="subt5" id="subt5" type="text" class="cajaPequena2"
                                                      value="<?php echo $subtotal5 - $descuento_ind5 + $iva5; ?>"
                        ...
                        <input name="idfactulinea5" id="idfactulinea5" type="hidden"
                               value="<?php echo $idfactulinea5; ?>">
                        ...
                        <input name="transformacion5" id="transformacion5" type="hidden"
                               value="<?php echo $transformacion5; ?>">
                        <input name="precio_con_iva5" id="precio_con_iva5" type="hidden"
                               value="<?php echo $precio_con_iva5; ?>">
                        ...
                        <?php if ($iva5 != 0) { ?>
                            <input NAME="ivaporc5" id="ivaporc5" <?php echo $ivaporcetaje; ?> type="hidden"
                                   onChange="suma_iva(5)">
                        <?php } else { ?>
                        ...
                        <tr class="itemImparTabla">
                            ...
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(5)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion5" id="descripcion5" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" onClick="ventanaArticulos(5)" readonly>
                                <input style="display: none" name="grabaiva5" id="grabaiva5" class="cajaExtraMinima"
                                       readonly>
                            </td>
                            <td align="center">
                            ...
                            <td align="center"><input NAME="cantidad5" id="cantidad5" type="text" class="cajaMinima"
                                                      ...
                                                      onChange="actualizar_importe(5)"></td>
                            <td align="center"><input NAME="precio5" id="precio5" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" onChange="actualizar_importe(5)"></td>

                            <td align="center">
                                <input NAME="descuentoporc5" id="descuentoporc5" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(5)" value="0">%
                                <input NAME="descuento5" id="descuento5" type="text" class="cajaPequena2" size="10"
                    ...
                    if ($idfactulinea6) {
                        ...
                        ?>
                        <tr class="itemParTabla">
                            <td><input NAME="codarticulo6" id="codarticulo6" type="text" class="cajaPequena" size="15"
                                       maxlength="15" value="<?php echo $codarticulo6; ?>" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(6)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion6" id="descripcion6" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" value="<?php echo $descripcion6; ?>"
                                       onClick="ventanaArticulos(6)" readonly>
                                <?php if ($iva6 != 0) { ?>
                                    <input style="display: inherit" name="grabaiva6" id="grabaiva6"
                                           class="cajaExtraMinima" readonly>
                                <?php } else { ?>
                            ...
                            <td align="center"><input NAME="cantidad6" id="cantidad6" type="text" class="cajaMinima"
                                                      size="10" maxlength="10" value="<?php echo $cantidad6; ?>"
                                                      onChange="actualizar_importe(6)"></td>
                            <td align="center"><input NAME="precio6" id="precio6" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" value="<?php echo $precio6; ?>"
                                                      onChange="actualizar_importe(6)"></td>

                            <td align="center">
                                <input NAME="descuentoporc6" id="descuentoporc6" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(6)"
                                       value="<?php echo $descuento_porcentaje6; ?>">%
                                <input NAME="descuento6" id="descuento6" type="text" class="cajaPequena2" size="10"
                                       maxlength="10" value="<?php echo $descuento_ind6; ?>"
                                       onchange="actualizar_porcentaje_descuento(6)">&#36;
                            </td>

                            <td align="center"><input NAME="subt6" id="subt6" type="text" class="cajaPequena2"
                                                      value="<?php echo $subtotal6 - $descuento_ind6 + $iva6; ?>"
                        ...
                        <input name="idfactulinea6" id="idfactulinea6" type="hidden"
                               value="<?php echo $idfactulinea6; ?>">
                        ...
                        <input name="transformacion6" id="transformacion6" value="<?php echo $transformacion6; ?>"
                               type="hidden">
                        <input name="precio_con_iva6" id="precio_con_iva6" value="<?php echo $precio_con_iva6; ?>"
                               type="hidden">
                        ...
                        <?php if ($iva6 != 0) { ?>
                            <input NAME="ivaporc6" id="ivaporc6" type="hidden" <?php echo $ivaporcetaje; ?>
                                   onChange="suma_iva(6)">
                        <?php } else { ?>
                        ...
                        <tr class="itemParTabla">
                            ...
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(6)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion6" id="descripcion6" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" onClick="ventanaArticulos(6)" readonly>
                                <input style="display: none" name="grabaiva6" id="grabaiva6" class="cajaExtraMinima"
                                       readonly>
                            </td>
                            <td align="center">
                            ...
                            <td align="center"><input NAME="cantidad6" id="cantidad6" type="text" class="cajaMinima"
                                                      ...
                                                      onChange="actualizar_importe(6)"></td>
                            <td align="center"><input NAME="precio6" id="precio6" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" onChange="actualizar_importe(6)"></td>

                            <td align="center">
                                <input NAME="descuentoporc6" id="descuentoporc6" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(6)" value="0">%
                                <input NAME="descuento6" id="descuento6" type="text" class="cajaPequena2" size="10"
                    ...
                    if ($idfactulinea7) {
                        ...
                        ?>
                        <tr class="itemImparTabla">
                            <td><input NAME="codarticulo7" id="codarticulo7" type="text" class="cajaPequena" size="15"
                                       maxlength="15" value="<?php echo $codarticulo7; ?>" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(7)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion7" id="descripcion7" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" value="<?php echo $descripcion7; ?>"
                                       onClick="ventanaArticulos(7)" readonly>
                                <?php if ($iva7 != 0) { ?>
                                    <input style="display: inherit" name="grabaiva7" id="grabaiva7"
                                           class="cajaExtraMinima" readonly>
                                <?php } else { ?>
                            ...
                            <td align="center"><input NAME="cantidad7" id="cantidad7" type="text" class="cajaMinima"
                                                      size="10" maxlength="10" value="<?php echo $cantidad7; ?>"
                                                      onChange="actualizar_importe(7)"></td>
                            <td align="center"><input NAME="precio7" id="precio7" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" value="<?php echo $precio7; ?>"
                                                      onChange="actualizar_importe(7)"></td>

                            <td align="center">
                                <input NAME="descuentoporc7" id="descuentoporc7" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(7)"
                                       value="<?php echo $descuento_porcentaje7; ?>">%
                                <input NAME="descuento7" id="descuento7" type="text" class="cajaPequena2" size="10"
                                       maxlength="10" value="<?php echo $descuento_ind7; ?>"
                                       onchange="actualizar_porcentaje_descuento(7)">&#36;
                            </td>

                            <td align="center"><input NAME="subt7" id="subt7" type="text" class="cajaPequena2"
                                                      value="<?php echo $subtotal7 - $descuento_ind7 + $iva7; ?>"
                        ...
                        <input name="idfactulinea7" id="idfactulinea7" type="hidden"
                               value="<?php echo $idfactulinea7; ?>">
                        ...
                        <input name="transformacion7" id="transformacion7" type="hidden"
                               value="<?php echo $transformacion7; ?>">
                        <input name="precio_con_iva7" id="precio_con_iva7" type="hidden"
                               value="<?php echo $precio_con_iva7; ?>">
                        ...
                        <?php if ($iva7 != 0) { ?>
                            <input NAME="ivaporc7" id="ivaporc7" type="hidden" <?php echo $ivaporcetaje; ?>
                                   onChange="suma_iva(7)">
                        <?php } else { ?>
                        ...
                        <tr class="itemImparTabla">
                            ...
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(7)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion7" id="descripcion7" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" onClick="ventanaArticulos(7)" readonly>
                                <input style="display: none" name="grabaiva7" id="grabaiva7" class="cajaExtraMinima"
                                       readonly>
                            </td>
                            <td align="center">
                            ...
                            <td align="center"><input NAME="cantidad7" id="cantidad7" type="text" class="cajaMinima"
                                                      ...
                                                      onChange="actualizar_importe(7)"></td>
                            <td align="center"><input NAME="precio7" id="precio7" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" onChange="actualizar_importe(7)"></td>

                            <td align="center">
                                <input NAME="descuentoporc7" id="descuentoporc7" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(7)" value="0">%
                                <input NAME="descuento7" id="descuento7" type="text" class="cajaPequena2" size="10"
                    ...
                    if ($idfactulinea8) {
                        ...
                        ?>
                        <tr class="itemParTabla">
                            <td><input NAME="codarticulo8" id="codarticulo8" type="text" class="cajaPequena"
                                       value="<?php echo $codarticulo8; ?>" size="15" maxlength="15" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(8)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion8" id="descripcion8" type="text" class="cajaExtraGrande"
                                       value="<?php echo $descripcion8; ?>" size="30" maxlength="30"
                                       onClick="ventanaArticulos(8)" readonly>
                                <?php if ($iva8 != 0) { ?>
                                    <input style="display: inherit" name="grabaiva8" id="grabaiva8"
                                           class="cajaExtraMinima" readonly>
                                <?php } else { ?>
                            ...
                            <td align="center"><input NAME="cantidad8" id="cantidad8" type="text" class="cajaMinima"
                                                      value="<?php echo $cantidad8; ?>" size="10" maxlength="10"
                                                      value="1" onChange="actualizar_importe(8)"></td>
                            <td align="center"><input NAME="precio8" id="precio8" type="text" class="cajaPequena2"
                                                      value="<?php echo $precio8; ?>" size="10" maxlength="10"
                                                      onChange="actualizar_importe(8)"></td>

                            <td align="center">
                                <input NAME="descuentoporc8" id="descuentoporc8" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(8)"
                                       value="<?php echo $descuento_porcentaje8; ?>">%
                                <input NAME="descuento8" id="descuento8" type="text" class="cajaPequena2"
                                       value="<?php echo $descuento_ind8; ?>" size="10" maxlength="10"
                                       onchange="actualizar_porcentaje_descuento(8)">&#36;
                            </td>

                            <td align="center"><input NAME="subt8" id="subt8" type="text" class="cajaPequena2"
                                                      value="<?php echo $subtotal8 - $descuento_ind8 + $iva8; ?>"
                            ...
                            <td width="4%" align="center"><img src="../img/eliminar.png" width="16" height="16"
                                                               ...
                                                               onMouseOver="style.cursor = cursor" title="Eliminar">
                            </td>
                        </tr>

                        <input name="idfactulinea8" id="idfactulinea8" type="hidden"
                               value="<?php echo $idfactulinea8; ?>">
                        ...
                        <input name="transformacion8" id="transformacion8" value="<?php echo $transformacion8; ?>"
                               type="hidden">
                        <input name="precio_con_iva8" id="precio_con_iva8" value="<?php echo $precio_con_iva8; ?>"
                               type="hidden">
                        ...
                        <?php if ($iva8 != 0) { ?>
                            <input NAME="ivaporc8" id="ivaporc8" <?php echo $ivaporcetaje; ?> type="hidden"
                                   onChange="suma_iva(8)">
                        <?php } else { ?>
                        ...
                        ?>
                        <tr class="itemParTabla">
                            <td><input NAME="codarticulo8" id="codarticulo8" type="text" class="cajaPequena" size="15"
                                       maxlength="15" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(8)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion8" id="descripcion8" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" onClick="ventanaArticulos(8)" readonly>
                                <input style="display: none" name="grabaiva8" id="grabaiva8" class="cajaExtraMinima"
                                       readonly>
                            </td>
                            ...
                            <td align="center"><input NAME="cantidad8" id="cantidad8" type="text" class="cajaMinima"
                                                      ...
                                                      onChange="actualizar_importe(8)"></td>
                            <td align="center"><input NAME="precio8" id="precio8" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" onChange="actualizar_importe(8)"></td>

                            <td align="center">
                                <input NAME="descuentoporc8" id="descuentoporc8" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(8)" value="0">%
                    ...
                    if ($idfactulinea9) {
                        ...
                        ?>
                        <tr class="itemImparTabla">
                            <td><input NAME="codarticulo9" id="codarticulo9" type="text" class="cajaPequena"
                                       value="<?php echo $codarticulo9; ?>" size="15" maxlength="15" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(9)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion9" id="descripcion9" type="text" class="cajaExtraGrande"
                                       value="<?php echo $descripcion9; ?>" size="30" maxlength="30"
                                       onClick="ventanaArticulos(9)" readonly>
                                <?php if ($iva9 != 0) { ?>
                                    <input style="display: inherit" name="grabaiva9" id="grabaiva9"
                                           class="cajaExtraMinima" readonly>
                                <?php } else { ?>
                            ...
                            <td align="center"><input NAME="cantidad9" id="cantidad9" type="text" class="cajaMinima"
                                                      value="<?php echo $cantidad9; ?>" size="10" maxlength="10"
                                                      value="1" onChange="actualizar_importe(9)"></td>
                            <td align="center"><input NAME="precio9" id="precio9" type="text" class="cajaPequena2"
                                                      value="<?php echo $precio9; ?>" size="10" maxlength="10"
                                                      onChange="actualizar_importe(9)"></td>

                            <td align="center">
                                <input NAME="descuentoporc9" id="descuentoporc9" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(9)"
                                       value="<?php echo $descuento_porcentaje9; ?>">%
                                <input NAME="descuento9" id="descuento9" type="text" class="cajaPequena2"
                                       value="<?php echo $descuento_ind9; ?>" size="10" maxlength="10"
                                       onchange="actualizar_porcentaje_descuento(9)">&#36;
                            </td>

                            <td align="center"><input NAME="subt9" id="subt9" type="text" class="cajaPequena2"
                                                      value="<?php echo $subtotal9 - $descuento_ind9 + $iva9; ?>"
                        ...
                        <input name="idfactulinea9" id="idfactulinea9" type="hidden"
                               value="<?php echo $idfactulinea9; ?>">
                        ...
                        <input name="transformacion9" id="transformacion9" value="<?php echo $transformacion9; ?>"
                               type="hidden">
                        <input name="precio_con_iva9" id="precio_con_iva9" value="<?php echo $precio_con_iva9; ?>"
                               type="hidden">
                        ...
                        <?php if ($iva9 != 0) { ?>
                            <input NAME="ivaporc9" id="ivaporc9" <?php echo $ivaporcetaje; ?> type="hidden"
                                   onChange="suma_iva(9)">
                        <?php } else { ?>
                        ...
                        ?>
                        <tr class="itemImparTabla">
                            <td><input NAME="codarticulo9" id="codarticulo9" type="text" class="cajaPequena" size="15"
                                       maxlength="15" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(9)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion9" id="descripcion9" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" onClick="ventanaArticulos(9)" readonly>
                                <input style="display: none" name="grabaiva9" id="grabaiva9" class="cajaExtraMinima"
                                       readonly>
                            </td>
                            <td align="center">
                            ...
                            <td align="center"><input NAME="cantidad9" id="cantidad9" type="text" class="cajaMinima"
                                                      ...
                                                      onChange="actualizar_importe(9)"></td>
                            <td align="center"><input NAME="precio9" id="precio9" type="text" class="cajaPequena2"
                                                      size="10" maxlength="10" onChange="actualizar_importe(9)"></td>

                            <td align="center">
                                <input NAME="descuentoporc9" id="descuentoporc9" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(9)" value="0">%
                    ...
                    if ($idfactulinea10) {
                        ...
                        ?>
                        <tr class="itemParTabla">
                            <td><input NAME="codarticulo10" id="codarticulo10" type="text" class="cajaPequena"
                                       value="<?php echo $codarticulo10; ?>" size="15" maxlength="15" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(10)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion10" id="descripcion10" type="text" class="cajaExtraGrande"
                                       value="<?php echo $descripcion10; ?>" size="30" maxlength="30"
                                       onClick="ventanaArticulos(10)" readonly>
                                <?php if ($iva10 != 0) { ?>
                                    <input style="display: inherit" name="grabaiva10" id="grabaiva10"
                                           class="cajaExtraMinima" readonly>
                                <?php } else { ?>
                                    <input style="display: none" name="grabaiva10" id="grabaiva10"
                                           class="cajaExtraMinima" readonly>
                                <?php } ?>
                            </td>
                            ...
                            <td align="center"><input NAME="cantidad10" id="cantidad10" type="text" class="cajaMinima"
                                                      value="<?php echo $cantidad10; ?>" size="10" maxlength="10"
                                                      value="1" onChange="actualizar_importe(10)"></td>
                            <td align="center"><input NAME="precio10" id="precio10" type="text" class="cajaPequena2"
                                                      value="<?php echo $precio10; ?>" size="10" maxlength="10"
                                                      onChange="actualizar_importe(10)"></td>

                            <td align="center">
                                <input NAME="descuentoporc10" id="descuentoporc10" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(10)"
                                       value="<?php echo $descuento_porcentaje10; ?>">%
                                <input NAME="descuento10" id="descuento10" type="text" class="cajaPequena2"
                                       value="<?php echo $descuento_ind10; ?>" size="10" maxlength="10"
                                       onchange="actualizar_porcentaje_descuento(10)">&#36;
                            </td>

                            <td align="center"><input NAME="subt10" id="subt10" type="text" class="cajaPequena2"
                                                      value="<?php echo $subtotal10 - $descuento_ind10 + $iva10; ?>"
                        ...
                        <input name="idfactulinea10" id="idfactulinea10" type="hidden"
                               value="<?php echo $idfactulinea10; ?>">
                        ...
                        <input name="transformacion10" id="transformacion10" value="<?php echo $transformacion10; ?>"
                               type="hidden">
                        <input name="precio_con_iva10" id="precio_con_iva10" value="<?php echo $precio_con_iva10; ?>"
                               type="hidden">
                        ...
                        <?php if ($iva10 != 0) { ?>
                            <input NAME="ivaporc10" id="ivaporc10" <?php echo $ivaporcetaje; ?> type="hidden"
                                   onChange="suma_iva(10)">
                        <?php } else { ?>
                        ...
                        ?>
                        <tr class="itemParTabla">
                            <td><input NAME="codarticulo10" id="codarticulo10" type="text" class="cajaPequena" size="15"
                                       maxlength="15" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(10)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion10" id="descripcion10" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" onClick="ventanaArticulos(10)" readonly>
                            ...
                            <td align="center">
                                <input NAME="descuentoporc10" id="descuentoporc10" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(10)" value="0">%
                            ...
                            <td align="center"><input NAME="subt10" id="subt10" type="text" class="cajaPequena2"
                                                      value="0" onchange="actualizar_totales(10)" readonly></td>
                            <td align="center"><img src="../img/eliminar.png" width="16" height="16"
                                                    onClick="limpiar_articulo(10)" onMouseOver="style.cursor = cursor"
                                                    title="Eliminar"></td>
                        </tr>
                    ...
                    if ($idfactulinea11) {
                        ...
                        ?>
                        <tr class="itemImparTabla">
                            <td><input NAME="codarticulo11" id="codarticulo11" type="text" class="cajaPequena"
                                       value="<?php echo $codarticulo11; ?>" size="15" maxlength="15" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(11)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion11" id="descripcion11" type="text" class="cajaExtraGrande"
                                       value="<?php echo $descripcion11; ?>" size="30" maxlength="30"
                                       onClick="ventanaArticulos(11)" readonly>
                                <?php if ($iva11 != 0) { ?>
                                    <input style="display: inherit" name="grabaiva11" id="grabaiva11"
                                           class="cajaExtraMinima" readonly>
                                <?php } else { ?>
                                    <input style="display: none" name="grabaiva11" id="grabaiva11"
                                           class="cajaExtraMinima" readonly>
                                <?php } ?>
                            </td>
                            ...
                            <td align="center"><input NAME="cantidad11" id="cantidad11" type="text" class="cajaMinima"
                                                      value="<?php echo $cantidad11; ?>" size="10" maxlength="10"
                                                      value="1" onChange="actualizar_importe(11)"></td>
                            <td align="center"><input NAME="precio11" id="precio11" type="text" class="cajaPequena2"
                                                      value="<?php echo $precio11; ?>" size="10" maxlength="10"
                                                      onChange="actualizar_importe(11)"></td>
                            <td align="center">
                                <input NAME="descuentoporc11" id="descuentoporc11" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(11)"
                                       value="<?php echo $descuento_porcentaje11; ?>">%
                                <input NAME="descuento11" id="descuento11" type="text" class="cajaPequena2"
                                       value="<?php echo $descuento_ind11; ?>" size="10" maxlength="10"
                                       onchange="actualizar_porcentaje_descuento(11)">&#36;
                            </td>
                            <td align="center"><input NAME="subt11" id="subt11" type="text" class="cajaPequena2"
                                                      value="<?php echo $subtotal11 - $descuento_ind11 + $iva11; ?>"
                        ...
                        <input name="idfactulinea11" id="idfactulinea11" type="hidden"
                               value="<?php echo $idfactulinea11; ?>">
                        ...
                        <input name="transformacion11" id="transformacion11" value="<?php echo $transformacion11; ?>"
                               type="hidden">
                        <input name="precio_con_iva11" id="precio_con_iva11" value="<?php echo $precio_con_iva11; ?>"
                               type="hidden">
                        ...
                        <?php if ($iva11 != 0) { ?>
                            <input NAME="ivaporc11" id="ivaporc11" <?php echo $ivaporcetaje; ?> type="hidden"
                                   onChange="suma_iva(11)">
                        <?php } else { ?>
                        ...
                        ?>
                        <tr class="itemImparTabla">
                            <td><input NAME="codarticulo11" id="codarticulo11" type="text" class="cajaPequena" size="15"
                                       maxlength="15" readonly></td>
                            <td>
                                <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos(11)"
                                     onMouseOver="style.cursor = cursor" title="Buscar articulos">
                                <input NAME="descripcion11" id="descripcion11" type="text" class="cajaExtraGrande"
                                       size="30" maxlength="30" onClick="ventanaArticulos(11)" readonly>
                            ...
                            <td align="center">
                                <input NAME="descuentoporc11" id="descuentoporc11" type="text" class="cajaMinima"
                                       size="10" maxlength="10" onChange="actualizar_descuento(11)" value="0">%
                            ...
                            <td align="center"><input NAME="subt11" id="subt11" type="text" class="cajaPequena2"
                                                      value="0" onchange="actualizar_totales(11)" readonly></td>
                            <td align="center"><img src="../img/eliminar.png" width="16" height="16"
                                                    onClick="limpiar_articulo(11)" onMouseOver="style.cursor = cursor"
                                                    title="Eliminar"></td>
                        </tr>
