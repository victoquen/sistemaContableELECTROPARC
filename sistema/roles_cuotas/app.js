...
var ApiUrl= function(){
    ...
    this.getEmpleados=function(){
        return 'http://localhost/sistemaContableELECTROPARC/sistema/roles_cuotas/selectEmpleado.php';
    }
    this.getContrato=function(){
        return 'http://localhost/sistemaContableELECTROPARC/sistema/roles_cuotas/selecContrato.php';
    }
    this.getRol=function(){
        return 'http://localhost/sistemaContableELECTROPARC/sistema/roles_cuotas/addOne.php';
    }
    this.getModRol=function(){
        return 'http://localhost/sistemaContableELECTROPARC/sistema/roles_cuotas/modificar.php';
    }
    this.getContratoIns=function(){
        return 'http://localhost/sistemaContableELECTROPARC/sistema/roles_cuotas/insertContrato.php';
    }
    this.getCuotas=function(){
        return 'http://localhost/sistemaContableELECTROPARC/sistema/roles_cuotas/addPagos.php';
    }
    this.getContratoCred=function(){
        return 'http://localhost/sistemaContableELECTROPARC/sistema/roles_cuotas/getContratosActivos.php';
    }
    this.getCuotasPago=function(){
        return 'http://localhost/sistemaContableELECTROPARC/sistema/roles_cuotas/getCuotas.php';
    }
    this.getUpdatePago=function(){
        return 'http://localhost/sistemaContableELECTROPARC/sistema/roles_cuotas/updatePago.php';
    }
    this.getAllRoles1=function(){
        return 'http://localhost/sistemaContableELECTROPARC/sistema/roles_cuotas/selectAll.php';
    }
