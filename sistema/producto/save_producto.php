...
if ($accion=="alta") {
        ...
        $idproducto = $producto->save_producto($conn, $codigo, $nombre, $stock, $costo, $pvp,$iva, $composicion,$aplicacion, $proveedor,$grupo,$subgrupo,$stock_consignacion,$gasto,$utilidad,$bodega);
